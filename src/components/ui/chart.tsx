...
interface ExtendedTooltipProps extends Partial<RechartsPrimitive.TooltipProps<any, string>> {
  active?: boolean;
  ...
  return (
    ...
    >
      {formatter && item?.value !== undefined && item.name !== undefined ? (
        formatter(
          item.value,
          String(item.name),     // Make sure name is string
          item,                  // Pass current item
          index,
          payload                // Pass full payload array here, NOT item.payload
        )
      ) : (
        <>
          {itemConfig?.icon ? (
